...
//#define DEF_I2C_ADDR_7B     (0x50)      // PSF PVC Address;
//#define DEF_I2C_ADDR_7B     (0x98>>1)
#define DEF_I2C_ADDR_7B     (0x13)      // For PGS7000_V1.0 or E1-PGS7000 Address;

//#define DEF_I2C_ADDR_7B     (0x28)      // For FS3000 or PAV3000 Address;
...
void Usr_I2C_MainLoop(unsigned char dat)
{
    ...
    else if(dat == 'd')     // Read TempCompPara;
    {   // Read TmprCmpPara;
    ...
    else if(dat == 'e')     // Write TmprCompPara;
    {   // Write TmprCompPara;
    ...
    {   // Read Raw data;
        ...
        if(true == rtn)
        {
            ...
            if(chksum == i2cBuff[0])
            {
                printf("\tChk = 0x%02X,\tOK,",chksum);
            }
            else
            {
                printf("\tChk = 0x%02X,\tNG,",chksum);
            }
